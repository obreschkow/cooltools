...
#' @param projection type of projection: "globe" (default), "cylincrical", "mollweide"
#' @param col color map
...
sphereplot = function(f, n = 100, theta0 = pi/2, phi0 = 0, angle = 0, projection='globe',
                      ...
                      pch = 16, pt.col='black', pt.cex=0.5, lwd = 1, lty = 1, line.col = 'black', background = 'white', ...) {
  ...
  # initialize plot
  if (!add) nplot(center[1]+radius*xlim,center[2]+radius*ylim,asp=1)#,pty='s')
