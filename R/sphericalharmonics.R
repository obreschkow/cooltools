...
#' @param basis a string specifying the type of spherical harmonics; this has to be either "complex" (default) for the standard complex-valued harmonics with Condon-Shortley phase convention, or "real" for the standard real-valued harmonics.
#'
...
sphericalharmonics = function(l, m, x, basis='complex') {
