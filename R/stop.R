...
#'
#' @description Stops the code and produces an error message, like the stop() function of the base library, but terminating a timer started with \code{\link{tick}}, if needed.
#'
