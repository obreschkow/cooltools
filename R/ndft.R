...
#'
#' @importFrom magicaxis magcurve magplot
...
#' # Plot signal
#' par(mfrow = c(1, 2))
#' magicaxis::magcurve(s,0,1,500,xaxs='i',main='Time signal',xlab='Time t',ylab='s(t)',col='grey')
...
#' magicaxis::magplot(nu,power.uniform,pch=16,cex=0.8,xlim=c(0,N/2),xaxs='i',
